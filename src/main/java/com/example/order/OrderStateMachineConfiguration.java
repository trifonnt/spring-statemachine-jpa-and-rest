...
@Configuration
@EnableStateMachineFactory(contextEvents = false) //@Trifon - old: contextEvents = false
public class OrderStateMachineConfiguration extends EnumStateMachineConfigurerAdapter<OrderState, OrderEvent> {

	private final Logger log = LoggerFactory.getLogger(OrderStateMachineConfiguration.class);
...
//			.end(OrderState.Completed) //@Trifon - Test throws error!
		;
	}
	...
	public StateMachineListener<OrderState, OrderEvent> loggingListener() {
		StateMachineListenerAdapter<OrderState, OrderEvent> listenerAdapter = new StateMachineListenerAdapter<>() {
			...
			public void stateChanged(State<OrderState, OrderEvent> from, State<OrderState, OrderEvent> to) {
				log.info("TRIFON - State changed from {} to {}", from == null ? null : from.getId(), to.getId());
			}
			@Override
